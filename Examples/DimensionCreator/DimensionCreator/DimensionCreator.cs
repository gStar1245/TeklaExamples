...
namespace DimensionCreator
{
    class DimensionCreator
    {
        ...
        public static void CreateRadiusDimension(double distance)
        {
            PointList pointList = new PointList();
            ViewBase view = null;
            PickPoints(3, ref pointList, ref view);
        ...
        internal static void CreateCurvedRadialDimension(double distance)
        {
            ...
            ViewBase view = null;
            PickPoints(Points, ref pointList, ref view);
            new CurvedDimensionSetHandler().CreateCurvedDimensionSetRadial(view, pointList[0], pointList[1], pointList[2], pointList, distance);
